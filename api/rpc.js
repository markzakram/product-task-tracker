...
const HANDLERS = {
  ...
  getPackages: () => backend.getPackages(),
...
module.exports = async (req, res) => {
  ...
  const MAGANG_DENY = {
    ...
    deleteTask: 1, deleteCollab: 1, saveCollab: 1, setCollabType: 1, savePackage: 1, deletePackage: 1, setCollabPackage: 1, setPackageContrib: 1,
  };
